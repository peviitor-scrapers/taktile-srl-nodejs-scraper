[![Oportunitati SI Cariere](https://github.com/florinbighiu/taktile-srl-nodejs-scraper/actions/workflows/job-seeker-ro-spider.yml/badge.svg)](https://github.com/florinbighiu/taktile-srl-nodejs-scraper/actions/workflows/job-seeker-ro-spider.yml)
[![Automation Tests](https://github.com/florinbighiu/taktile-srl-nodejs-scraper/actions/workflows/automation-testing.yml/badge.svg)](https://github.com/florinbighiu/taktile-srl-nodejs-scraper/actions/workflows/automation-testing.yml)
[![Version](https://img.shields.io/github/package-json/v/florinbighiu/taktile-srl-nodejs-scraper?label=version&color=blue)](CHANGELOG.md)
[![Test Results](https://img.shields.io/badge/test--results-HTML-9b59b6)](https://florinbighiu.github.io/taktile-srl-nodejs-scraper/test-results/)
...
[![GitHub Pages](https://img.shields.io/github/deployments/florinbighiu/taktile-srl-nodejs-scraper/github-pages?label=GitHub%20Pages)](https://florinbighiu.github.io/taktile-srl-nodejs-scraper/)

# job_seeker_ro_spider — TAKTILE Scraper

**job_seeker_ro_spider** — un scraper pentru job-urile TAKTILE S.R.L. din România (Iași). Extrage anunțurile de pe [jobs.ashbyhq.com/taktile](https://jobs.ashbyhq.com/taktile) și le publică în [peviitor.ro](https://peviitor.ro) prin API-ul Peviitor.
...
Proiectul automatizează colectarea zilnică a job-urilor Taktile din România (postări unde Iași este locația primară sau secundară), menținând board-ul peviitor.ro la zi cu cele mai recente oportunități de carieră.

## Features

- Extrage job-uri din Taktile Ashby job board (API public, filtrare România/Iași)
